...
<template>
    ...
    <d-table
      ...
      api="bizSystemService.getRoleList"
      :params="queryForm"
      ref="roleTable">
      <el-table-column
        align="center"
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button v-if="authorityBtn.includes('sys_role_1002')" size="mini" type="primary" plain @click="roleHandle('add',scope.row)"  >修改</el-button>
      ...
      <el-dialog
        ...
        <div v-show="dialogType=='edit' || dialogType=='add'">
          <el-form label-width="80px" :model="addOrEditForm" ref="addOrEditForm" size="small">
